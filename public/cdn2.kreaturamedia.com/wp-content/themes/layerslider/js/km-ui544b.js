...
jQuery( function( $ ){
	...
	window.kmUI  = {
		...
		lsLogo: {
			...
			append: function( to, settings ){

				kmUI.lsLogo.settings = $.extend( true, {}, kmUI.lsLogo.defaults, settings );
				...
				if ( kmUI.lsLogo.settings.animate ){
					to.addClass( 'layerslider-logo-animated' );
				}

				if ( kmUI.lsLogo.settings.theme === 'dark' ){
					to.addClass( 'km-ui-theme-dark' );
				}
